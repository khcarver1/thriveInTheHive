...
function moBeeHiveLi1A() {
    ...
    beeHiveLi1A.style.height = "25px";
    headerLi1.style.display = "flex";
    headerLi1.style.alignItems = "center";
    headerLi1.style.marginLeft = "0px";
    headerLi0.style.marginRight = "0px";
...
function mlBeeHiveLi1A() {
    ...
    headerLi1.style.marginLeft = "20px";
    headerLi0.style.marginRight = "20px";
...
function moBeeHiveLi2A() {
    ...
    beeHiveLi2A.style.height = "25px";
    headerLi2.style.display = "flex";
    headerLi2.style.alignItems = "center";
    headerLi2.style.marginLeft = "0px";
    headerLi1.style.marginRight = "0px";
