...
function moBeeHiveLi0A() {
    ...
    beeHiveLi0A.setAttribute("src", "../favicon/beehivefavicon.png");
...
function moBeeHiveLi1A() {
    ...
    beeHiveLi1A.setAttribute("src", "../favicon/beehivefavicon.png");
...
function moBeeHiveLi2A() {
    ...
    beeHiveLi2A.setAttribute("src", "../favicon/beehivefavicon.png");
